...
//		Utils.DestroyAssets(childHolderObject);
	...
	public int GetTotalPOIsKey ()
	{
		return totalPOIsKey;
	}

	public int GetTotalPOIsNonKey ()
	{
		return totalPOIsNonKey;
	}

	public int GetKeyPoiSizeVal ()
	{
		return keyPoiSizeVal;
	}

	public int GetNonKeyPoiSizeVal ()
	{
